...
image: /static/docs/python.jpg
description: 'Python là ngôn ngữ lập trình hướng đối tượng, cấp cao, mạnh mẽ, được tạo ra
  bởi Guido van Rossum.'
---

# Ngôn ngữ lập trình Python là gì?

![Ngôn ngữ lập trình Python là gì](/static/docs/python.jpg)
...
thành một ngôn ngữ lý tưởng để viết script và phát triển ứng dụng trong nhiều
lĩnh vực, ở hầu hết các nền tảng.
