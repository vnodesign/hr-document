...
description: 'Expressjs hay còn được viết là Express js, Express.js. Đây là một framework
  mã nguồn mở miễn phí cho Node.js.'
---
...
Expressjs cũng là một framework của Node.js do đó hầu hết các mã code đã được
